...
function register_dashboard_menu_location() {
    register_nav_menu('dashboard-menu', 'قائمة لوحة المستخدم');
}
add_action('after_setup_theme', 'register_dashboard_menu_location');
