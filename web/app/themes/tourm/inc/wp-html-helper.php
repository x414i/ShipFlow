...
// image default alt
if( !function_exists( 'tourm_img_default_alt' ) ){
	function tourm_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'tourm_img_tag' ) ){
	function tourm_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'tourm_anchor_tag' ) ){
	function tourm_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'tourm_heading_tag' ) ){
	function tourm_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'tourm_paragraph_tag' ) ){
	function tourm_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'tourm_span_tag' ) ){
	function tourm_span_tag( array $args ){
