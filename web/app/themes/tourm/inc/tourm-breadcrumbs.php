...
if ( ! function_exists( 'tourm_breadcrumbs' ) ) {
    function tourm_breadcrumbs( $args = array() ) {
        if ( is_front_page() ) {
            return;
        }
        ...
        $home_page_title = tourm_opt('tourm_breadcrumb_home_title') ? tourm_opt('tourm_breadcrumb_home_title') : 'Home';
        ...
        $defaults  = array(
            ...
            'home_title'          => $home_page_title
        );
        $args    = apply_filters( 'tourm_breadcrumbs_args', wp_parse_args( $args, $defaults ) );
        ...
        */
        ...
        if ( is_singular( 'post' ) ) {
            ...
            $html .= '<li class="active bread-search">'.esc_html__('Search results for: ','tourm') . get_search_query() . '</li>';
        } elseif ( is_404() ) {
            $html .= '<li>' . esc_html__( 'Error Page', 'tourm' ) . '</li>';
        } elseif ( is_home() ) {
        ...
        if( class_exists('woocommerce') ) {
            ...
            echo apply_filters( 'tourm_breadcrumbs_filter', $html );
        }
